...
What the app does today, tab by tab, and what is still imagined. "Imagined" means the screen exists and is labelled that way inside the app; the data behind it is a seed.

## Opening

- The ritual on every open: the doorway video, the light, a held white and gold field, the app fading in. Tap to enter early.
- His song plays on open; one tap mutes it and the choice is kept.
- A different scene behind every page on every open, still or looping video, filling the whole screen on phone and desktop.
- Installable: add to home screen on Android and iPhone; works offline once opened.
...
- The Gratus Galaxy: People, Places, Projects, Partners. The map is real; the nodes beyond your own garden are imagined.
