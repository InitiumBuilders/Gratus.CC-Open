...
const V = 'gratus-1789867621';
const SHELL = ['/app.html', '/assets/css/tokens.css?v=36', '/assets/css/galaxy.css?v=36', '/assets/js/galaxy.js?v=1789867621', '/assets/js/ui.js?v=14', '/assets/js/views.js?v=17', '/assets/js/keep.js?v=13',
  '/engine/gratus.js?v=12', '/engine/emoji.js?v=12', '/engine/rng.js?v=12', '/engine/state.js?v=14', '/engine/glyph.js?v=17',
  '/config/evolutions.json?v=17', '/config/emoji-names.json?v=17', '/config/prompts.json?v=17', '/config/copy.json?v=17', '/config/growth-book.json?v=17', '/config/recipes.json?v=17', '/config/alchemy.json?v=17', '/config/families.json?v=17',
